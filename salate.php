...
<body id="page3">
    ...
    <section id="content"><div class="ic">More Website Templates @ TemplateMonster.com - January 23, 2012!</div>
        <div class="main">
            <div class="container">
            	<h3 class="prev-indent-bot">Salate</h3>
                <div>
                    <?php        
                    $url = 'http://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'] . '';
                    $meniu = explode("/", $url);                    
                    $query = mysql_query("SELECT * FROM preparate WHERE id_categorie = '2'");
...
//                        if($row['ingrediente']){
//                            echo '<ul>';
//                            $ingrediente = explode(',', $row['ingrediente']);
//                            foreach($ingrediente AS $key => $val){
//                                echo "<li>$val</li>";
//                            }
//                            echo '</ul>';
//                        }                        
                        echo '<p class="p1">'.$row['ingrediente'].'</p>
